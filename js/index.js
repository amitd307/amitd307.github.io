                ...
                if (currentcolor == 0x26D7E7) {
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Photography</span> : <a target="_blank" href="https://www.instagram.com/amit_dnath/" style="font-size: 22px; color: white;">Instagram <a> ';
                         document.getElementById('couleur').style.color="#ffc12d";
                        subtitle.innerHTML = "Since <span>January 2015</span>.";
                        description.innerHTML = "I love to do open air activity, so at whatever point i'm outside I can't stop my self to take photographs <br/><br/><div>Click on the other planets to learn more ...<div>";
                    ...
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==3) {
                        planetViewed = 4;
                        info.innerHTML = '<span id="couleur">SpiderCar</span> Startup <div>The vehicle utilizes the widespread capacity<div> ';
                         document.getElementById('couleur').style.color="#acacac";
                        subtitle.innerHTML = "Since <span>October 2016</span> .";
                        description.innerHTML = "Space vehicle have likewise go all over capacity, The vehicle utilizes the general capacity, when the vehicle experiences a snag, it will naturally go to another bearing..";
